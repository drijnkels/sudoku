...
export default function Select({label, id, options, onChange, value = '', error, disabled = false}: InputProps) {
  ...
  return (
    <div className="w-full mb-5">
      ...
      <select onChange={onChange} id={id} role='combobox' value={value} className={disabledClasses + " w-full py-3 px-6 outline-none rounded-md border-2 focus:shadow-md"}>
